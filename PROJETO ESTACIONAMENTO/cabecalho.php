...
<title>Sistema de Estacionamento Incrível</title>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="movimentacoes.php">Entradas e Saídas</a></li>
            <li><a class="dropdown-item" href="nova_movimentacao.php">Registrar Entrada</a></li>
          </ul>
        </li>
        <li class="nav-item">
